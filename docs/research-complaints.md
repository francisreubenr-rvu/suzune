...
Research date: 2026-07-03. Compiled for the `suzune` project (local, open-source alternative to Wispr Flow). All claims are sourced; anecdotal/thin evidence is flagged as such.
