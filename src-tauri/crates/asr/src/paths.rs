...
/// ASR engines whispr can use. Each variant maps to one on-disk model
/// resolved relative to a models root directory (e.g. `/Volumes/1TB SSD/LM/whispr-models`).
...
/// (`/Volumes/1TB SSD/LM/whispr-models/parakeet-tdt-0.6b-v2-int8`).
