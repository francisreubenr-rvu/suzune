...
- Settings file materializes at ~/Library/Application Support/dev.suzune.app/settings.json (models_root defaults to /Volumes/1TB SSD/LM/suzune-models on this machine).
