...
- M3 remaining: settings editor UI (currently read-only), custom tray/app icon, waveform level metering on the pill (optional), engine-load stagger vs llama-server. Then M4: README, packaging (tauri build with bundle), GitHub push (private).
